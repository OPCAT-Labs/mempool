...
__ELECTRS_MAINNET_HTTP_HOST__=${ELECTRS_MAINNET_HTTP_HOST:=127.0.0.1}
__ELECTRS_MAINNET_HTTP_PORT__=${ELECTRS_MAINNET_HTTP_PORT:=3006}
__TRACKER_HTTP_HOST__=${TRACKER_HTTP_HOST:=127.0.0.1}
__TRACKER_HTTP_PORT__=${TRACKER_HTTP_PORT:=3000}
...
sed -i "s/__ELECTRS_MAINNET_HTTP_HOST__/${__ELECTRS_MAINNET_HTTP_HOST__}/g" /etc/nginx/conf.d/nginx-mempool.conf
sed -i "s/__ELECTRS_MAINNET_HTTP_PORT__/${__ELECTRS_MAINNET_HTTP_PORT__}/g" /etc/nginx/conf.d/nginx-mempool.conf
sed -i "s/__TRACKER_HTTP_HOST__/${__TRACKER_HTTP_HOST__}/g" /etc/nginx/conf.d/nginx-mempool.conf
sed -i "s/__TRACKER_HTTP_PORT__/${__TRACKER_HTTP_PORT__}/g" /etc/nginx/conf.d/nginx-mempool.conf
...
__BLOCK_WEIGHT_UNITS__=${BLOCK_WEIGHT_UNITS:=32000000}
